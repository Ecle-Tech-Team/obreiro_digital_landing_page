...
export default function Home() {
  const plans = [
    ...
    },
    {
      ...
      features: [
        "Tudo do starter",
        "Certificado de conclusão de todos os cursos extras",
      ],
    },
    {
      title: "Prata",
    ...
    <main className="font-poppins">
      ...
      <section className="h-[60vh] w-auto flex flex-col items-center ">
        ...
        <div className="mt-[3vh] w-[50vh] flex justify-evenly xl:mt-[5vh]">
          ...
          <Check />
          <h2 className="font-bold">Sem limitação de uso</h2>
        </div>
      </section>
        ...
        <Card className="w-[100%] flex flex-col justify-center items-center border-0 xl:mb-15">
          <div className="xl:flex xl:items-center xl:mb-0 xl:gap-48">
            <CardContent className="flex flex-col text-center">
              <h1 className="text-7xl xl:mt-[8vh] font-bold text-[#1E1E1E]">
                3º
              </h1>
              <div className="flex justify-center">
                <h2 className="text-xl font-bold xl:mb-5 text-[#1E1E1E]">
                  Maior Causa de{" "}
            ...
            <div className="flex flex-col xl:flex-row xl:justify-evenly items-center">
              <Card className="bg-[#F5F5F5] w-[32vh] xl:w-[50vh] xl:h-[50vh] mb-11 xl:mb-0 shadow-md">
                <CardContent className="p-7">
                  ...
                  <div className="flex">
                    <Star fill="#FFCB69" className="text-[#FFCB69]" />
                    <Star fill="#FFCB69" className="text-[#FFCB69]" />
                    <Star fill="#FFCB69" className="text-[#FFCB69]" />
                    <Star fill="#FFCB69" className="text-[#FFCB69]" />
                    <Star fill="#FFCB69" className="text-[#FFCB69]" />
              ...
              <Card className="bg-[#F5F5F5] w-[32vh] xl:w-[50vh] xl:h-[50vh] mb-11 xl:mb-0 shadow-md">
                <CardContent className="p-7">
                  ...
                  <div className="font-semibold mt-5">
                    <h2 className="mb-1">Pastor Carlos Felipe</h2>
                    <h2>Assembléia de Deus Belém 47</h2>
                  </div>
                </CardContent>
              </Card>
              <Card className="bg-[#F5F5F5] w-[32vh] xl:w-[50vh] xl:h-[50vh] shadow-md">
                <CardContent className="p-7">
                  ...
                  <div className="font-semibold mt-5">
                    <h2 className="mb-1">Saulo Rocha</h2>
                    <h2>OBPC São Lourenço da Serra</h2>
                  </div>
                </CardContent>
              </Card>
            </div>
          ...
          <CardContent className="xl:px-[10vh]">
            ...
            <div className="text-center xl:text-start flex flex-col items-center xl:flex-row">
              <div className="xl:flex xl:flex-col xl:w-[90vh]">
                ...
                <p className="text-base mb-8 font-sans font-semibold text-gray-700">
              ...
              <Card className="bg-[#5271FF] w-[32vh] xl:w-[60vh] xl:h-[65vh] rounded-3xl ">
                <CardContent className="xl:my-6">
                  ...
                  <div className="text-white flex flex-col items-center text-lg mb-5">
                    <ul className="list-disc font-sans xl:text-xl font-bold xl:gap-16">
